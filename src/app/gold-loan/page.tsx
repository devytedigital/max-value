...
//       {/* HERO SECTION */}
//       <section className="relative w-full pt-28 pb-16 md:pt-36 md:pb-24 lg:pt-44 lg:pb-28 bg-[#147FC3] text-black overflow-hidden">
      ...
      <section className="relative w-full pt-28 pb-16 md:pt-36 md:pb-24 lg:pt-44 lg:pb-28 bg-white text-zinc-900 border-b border-zinc-200/80 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            {/* Right content (goldloanbanner.png from public folder) */}
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.15 }}
            ...
            >
              ...
              <div className="absolute -bottom-5 left-4 sm:left-6 bg-white text-zinc-900 rounded-xl p-4 shadow-xl border border-zinc-200 flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-wide">Purity Verified</p>
                  <p className="text-xs font-black text-zinc-900">100% Secure appraisal</p>
                </div>
              </div>
            </motion.div>
