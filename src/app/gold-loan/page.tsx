...
${formData.comment.trim()}`;
  ...
  return (
    <div className="relative min-h-screen bg-[#FAF9F6] text-zinc-900 overflow-x-hidden selection:bg-[#147FC3] selection:text-white font-sans">
      ...
      {/* HERO SECTION - INSTANT GOLD LOAN SOLUTIONS */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-black uppercase leading-[1.15] mb-4">
                LET YOUR DREAMS FLY<br />
                HIGH WITH<br />
                <span className="text-[#147FC3]">MAXVALUE GOLD LOANS</span>
              </h1>
              ...
              <div className="inline-block bg-[#F8FAFC] border border-slate-200/90 rounded-xl px-5 py-3.5 mb-8 shadow-xs">
                ...
                <p className="text-2xl font-black text-[#147FC3] mt-0.5">
                  ₹{goldRate ? goldRate.toLocaleString("en-IN") : "13,767"}{" "}
                  <span className="text-xs text-zinc-500 font-medium">/gram</span>
                </p>
              </div>
            ...
            >
              <div className="relative w-full max-w-[480px] lg:max-w-[500px] h-[450px] sm:h-[520px] lg:h-[560px] rounded-none overflow-hidden border border-slate-200/80 shadow-md bg-white">
                <img
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-zinc-200/90 p-8 md:p-10 relative overflow-hidden">
                ...
                <div className="mb-8 text-left">
                  ...
                  <p className="text-zinc-500 text-xs md:text-sm mt-1">
                    Fill in the details below. Submitting will open your official WhatsApp support chat .
                  </p>
                </div>
