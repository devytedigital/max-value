...
${formData.comment.trim()}`;
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Every application is handled with clear communication on eligibility, documentation, and charges, so there are no surprises along the way.",
      icon: <ShieldCheck className="w-6 h-6 text-[#147FC3]" />
    },
    {
      title: "Simple Documentation",
  ...
  return (
    <div className="relative min-h-screen bg-[#FAF9F6] text-zinc-900 overflow-x-hidden selection:bg-[#147FC3] selection:text-white font-sans">
      ...
      {/* HERO SECTION - DRIVE YOUR DREAMS FORWARD */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-black uppercase leading-tight mb-4">
                Drive your dreams forward with <br />
                <span className="text-[#147FC3]">MAXVALUE Vehicle Loans</span>
              </h1>
              ...
              <div className="inline-block bg-slate-50 border border-slate-200 rounded-xl p-4 mb-8 shadow-xs">
                <p className="text-[11px] uppercase tracking-wider text-zinc-500 font-bold">Loan Coverage</p>
                <p className="text-xl font-black text-[#147FC3] mt-0.5">
                  New <span className="text-xs text-zinc-500 font-medium">&</span> Used Vehicles
                </p>
              </div>
            ...
            {/* Right content (vehicleloanbanner.png from public folder) */}
            <motion.div
              initial={{ opacity: 0, x: 30 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.15 }}
            ...
            >
              <div className="relative mx-auto w-full max-w-[580px] rounded-2xl overflow-hidden border-2 border-slate-200/80 shadow-xl bg-white group">
                <img
                  src="https://res.cloudinary.com/ckam7yhu/image/upload/f_auto,q_auto/v1788164706/vehichleloanbanner.png"
                  alt="MaxValue Vehicle Loan Banner"
              ...
              <div className="absolute -bottom-5 left-4 sm:left-6 bg-white text-zinc-900 rounded-xl p-4 shadow-xl border border-zinc-200 flex items-center gap-3">
                ...
                <div className="text-left">
                  <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-wide">Quick Approval</p>
                  <p className="text-xs font-black text-zinc-900">New & Used Vehicles</p>
                </div>
              </div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 text-left">
              <span className="text-xs font-black tracking-widest text-[#FCA038] uppercase">MAXVALUE CREDITS</span>
              <h2 className="text-3xl md:text-4xl font-black text-[#147FC3] tracking-tight uppercase mt-2">
                Financing Built Around Your Journey
              </h2>
              <div className="w-16 h-1 bg-[#147FC3] rounded-full mt-4" />
            </div>
            ...
            <div className="lg:col-span-7 text-left text-zinc-600 text-sm md:text-base leading-relaxed flex flex-col gap-6">
              ...
              <p>
                From two-wheelers for daily commuting to four-wheelers for personal or commercial use, we work with you to structure a loan that fits your budget and repayment capacity. With minimal documentation and clear communication at every stage, applying for a Vehicle Loan with Max Value is straightforward from start to finish.
              </p>
              <p className="font-semibold text-zinc-800">
                With customer-focused service and a trusted branch network across South India, Max Value makes your journey to vehicle ownership smooth, reliable, and hassle-free.
              </p>
      ...
      <section className="relative w-full py-6 md:py-10 bg-transparent">
        <div className="max-w-3xl mx-auto px-6 md:px-8">
          ...
          >
            <img
              src="https://res.cloudinary.com/ckam7yhu/image/upload/f_auto,q_auto/v1788164582/adsbike.jpg"
              alt="MaxValue Vehicle Loan Special Promotion & Ad"
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-zinc-500 text-xs md:text-sm">
              We provide financing options designed to suit your budget and lifestyle, giving you greater convenience, reliability, and peace of mind.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 md:px-8">
          ...
          <div className="text-center mb-16 flex flex-col items-center">
            ...
            <p className="text-zinc-500 text-xs md:text-sm mt-4 max-w-sm">
              Got questions about our Vehicle Loan? Here are answers to the most common queries.
            </p>
          </div>
