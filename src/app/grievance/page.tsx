    ...
    <div className="relative min-h-screen bg-white text-zinc-900 overflow-x-hidden selection:bg-[#147FC3] selection:text-white font-sans">
      ...
      <section className="relative w-full py-20 md:py-28 bg-[#0c141c] text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10 text-center md:text-left">
          ...
          >
            {/* Tag Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#FCA038]/20 border border-[#FCA038]/40 text-[#FCA038] text-xs font-bold uppercase tracking-wider mb-4">
              <ShieldCheck className="w-3.5 h-3.5" />
              <span>Customer Redressal Cell</span>
            </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl border border-zinc-200/90 p-8 md:p-10 relative overflow-hidden">
                ...
                <div className="mb-8 text-left">
                  ...
                  <p className="text-zinc-500 text-xs md:text-sm mt-1">
                    Please provide full context of your complaint. Submitting will compile and transmit your grievance directly to our WhatsApp Redressal line (<strong className="text-zinc-800">8714771854</strong>).
                  </p>
                </div>
                  ...
                  <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-6 text-center flex flex-col items-center gap-4 my-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-emerald-700 mt-1 max-w-md">
                        Your complaint report is ready. If WhatsApp did not open automatically, please click the button below to send your details to 8714771854.
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <span>Send Grievance via WhatsApp (8714771854)</span>
