...
//       icon: <FileText className="w-6 h-6 text-[#147FC3]" />
//     },
//     {
//       title: "Flexible Repayment Options",
//       description: "Choose repayment schedules that are practical and manageable, helping you repay your loan with ease.",
//       icon: <Percent className="w-6 h-6 text-[#FCA038]" />
//     },
//     {
//       title: "Transparent Lending Process",
...
//                 <span className="text-[#FCA038]">Empower Communities</span>
//               </h1>
...
//                   <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-wide">Financial Inclusion</p>
//                   <p className="text-xs font-black text-zinc-800">Empowering Communities</p>
//                 </div>
//               </div>
//             </motion.div>
...
//       {/* WHY CHOOSE MAX VALUE MICROFINANCE (VISUAL GRID) */}
//       <section className="relative w-full py-16 md:py-24 bg-transparent">
