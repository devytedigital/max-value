...
const defaultActivities: Activity[] = [
  {
    id: "csr-tree-plantation-2026",
    title: "Green South India Drive: Tree Plantation Across 50 Regional Branches",
    category: "CSR & Community",
    date: "August 10, 2026",
    location: "Thrissur & Ernakulam Districts, Kerala",
    ...
    summary: "Over 2,500 saplings were planted in partnership with local civic bodies across Kerala and Karnataka to foster environmental sustainability.",
    content: "Max Value Credits & Investments Ltd. launched its annual 'Green South India' CSR campaign across 50 regional branches. Over 500 team members and local community volunteers participated in planting native trees, promoting eco-awareness, and instituting rainwater harvesting systems at community centers. Managing Director Mr. Manoj V B emphasized the organization's pledge to support sustainable green growth.",
    organizer: "Max Value CSR Foundation",
    participantsCount: "500+ Volunteers",
    tags: ["CSR", "Sustainability", "Community Outreach", "Green Initiative"],
    isFeatured: true,
  },
  {
    id: "financial-literacy-women-microfinance",
    title: "EmpowerHer: Women Financial Literacy & Micro-Entrepreneurship Workshop",
    category: "Financial Literacy",
    date: "July 24, 2026",
    location: "Jayanagar & Mysuru, Karnataka",
    ...
    summary: "Over 1,200 women micro-entrepreneurs received training on digital payment adoption, household budgeting, micro-credit access, and gold loan savings.",
    content: "EmpowerHer workshop was organized by Max Value Microfinance division to educate self-help group members on digital financial literacy, safe digital banking habits, and micro-loan management. Financial experts conducted hands-on sessions on using mobile wallets, micro-insurance benefits, and government credit schemes for small businesses.",
    organizer: "Max Value Microfinance & Financial Inclusion Wing",
    participantsCount: "1,200+ Women Entrepreneurs",
    tags: ["Financial Literacy", "Women Empowerment", "Microfinance", "Digital Banking"],
    isFeatured: false,
  },
  {
    id: "new-branch-inauguration-bangalore",
    title: "Grand Opening: Max Value Jayanagar Flagship Regional Hub & Gold Loan Center",
    category: "Branch Celebrations",
    date: "June 18, 2026",
    location: "Jayanagar 3rd Block, Bengaluru, Karnataka",
    ...
    summary: "Inauguration of Max Value's high-tech regional hub in Bengaluru equipped with automated gold purity testing and instant 3-minute disbursal counters.",
    content: "Max Value Credits expanded its Karnataka footprint with the inauguration of its state-of-the-art flagship center in Jayanagar, Bengaluru. The event was attended by prominent civic leaders, board directors, and banking dignitaries. The branch features private valuation lounges, 24/7 biometric gold lockers, and specialized traders credit desks.",
    organizer: "Bangalore Regional Operational Team",
    participantsCount: "300+ Guests & Patrons",
    tags: ["Branch Expansion", "Bengaluru", "Gold Loan Hub", "Innovation"],
    isFeatured: false,
  },
  {
    id: "annual-excellence-awards-2026",
    title: "Max Value Annual Leadership & Performance Excellence Awards 2026",
    category: "Awards & Accolades",
    date: "May 12, 2026",
    location: "Lulu International Convention Centre, Thrissur",
    ...
    summary: "Celebrating top-performing branch managers, credit officers, and operational teams across Kerala, Tamil Nadu, and Karnataka.",
    content: "The annual Max Value Excellence Convention honored over 75 stellar performers across 150+ branches. Awards were presented for Best Branch Customer Service, Zero-NPA Credit Management, and Digital Loan Growth. Keynote addresses were delivered by Chairman Mr. Manoj V B and senior directors.",
    organizer: "Max Value Corporate HR & Executive Board",
    participantsCount: "800+ Employees",
    tags: ["Employee Recognition", "Excellence Awards", "Corporate Milestone"],
    isFeatured: false,
  },
  {
    id: "blood-donation-and-health-camp",
    title: "Community Health & Blood Donation Drive in Association with Red Cross",
    category: "CSR & Community",
    date: "April 05, 2026",
    location: "Metropolitan Hospital Campus, Thrissur",
    ...
    summary: "Organized in collaboration with Metropolitan Hospital and Red Cross Society, collecting 350+ units of blood and offering free health checkups.",
    content: "Demonstrating our commitment to public health, Max Value Credits partnered with the Indian Red Cross Association to host a region-wide health checkup and blood donation drive. Over 450 citizens received free health screenings and eye checkups, alongside voluntary blood donations from Max Value staff.",
    organizer: "Indian Red Cross Society & Metropolitan Hospital",
    participantsCount: "450+ Beneficiaries",
    tags: ["CSR", "Health & Wellness", "Red Cross", "Blood Donation"],
    isFeatured: false,
  },
  {
    id: "sports-meet-and-employee-wellness",
    title: "MaxValue Premier League: Annual Employee Sports & Wellness Meet",
    category: "Employee Welfare",
    date: "March 15, 2026",
    location: "Corporation Stadium, Thrissur",
    bannerImage: "https://images.unsplash.com/photo-1517649763962-0c623266010b?auto=format&fit=crop&w=1200&q=80",
    gallery: [
      "https://images.unsplash.com/photo-1517649763962-0c623266010b?auto=format&fit=crop&w=800&q=80"
    ],
    summary: "A vibrant weekend of sports tournaments, athletics, and team-building events promoting health and camaraderie among regional workforce teams.",
    content: "Over 400 staff members representing Kerala and Karnataka zone teams competed in the annual MaxValue Premier League. The sports tournament aims to foster team synergy, physical wellbeing, and healthy work-life balance across all department units.",
    organizer: "Employee Welfare & Sports Committee",
    participantsCount: "400+ Team Members",
    tags: ["Sports Meet", "Employee Wellness", "Team Building", "Culture"],
    isFeatured: false,
  },
];
